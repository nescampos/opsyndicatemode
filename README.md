# opSyndicate for Mode
**opSyndicate for Mode** is an Investment Club platform to manage funds (treasury) in [Mode Network](https://mode.network).
opSyndicate for Mode is a fork of [opSyndicate](https://github.com/nescampos/opsyndicate)
...
## URL and information
----
- Project URL: https://nescampos.github.io/opsyndicatemode/
- Blockchain: Mode Testnet (Sepolia)
- Smart Contract ID: [0x3258814758AC48fE9c0869d43Df8F13aD0cB2A25](https://sepolia.explorer.mode.network/address/0x3258814758AC48fE9c0869d43Df8F13aD0cB2A25)
